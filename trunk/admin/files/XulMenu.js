...
function XulMenu(id) {
                ...
                case "section":
                    ...
                    if (el.level == 1) {
                        if (this.type == "horizontal") {
                            box2.style.top = (box1.offsetTop + box1.offsetHeight + this.position.level1.top-3) + "px";
                            if (this.browser.ie5) {
                                box2.style.left = (2+this.position.level1.left) + "px";
                            } else {
                                box2.style.left = (2+box1.offsetLeft + this.position.level1.left) + "px";
                            }
                        } else if (this.type == "vertical") {
                            box2.style.top = (box1.offsetTop + this.position.level1.top) + "px";
                            if (this.browser.ie5) {
                                box2.style.left = (2+box1.offsetWidth + this.position.level1.left) + "px";
                            } else {
                                box2.style.left = (2+box1.offsetLeft + box1.offsetWidth + this.position.level1.left) + "px";
                            }
                        }
                    } else {
                        box2.style.top = (box1.offsetTop + this.position.levelX.top-3) + "px";
                        box2.style.left = (2+box1.offsetLeft + box1.offsetWidth + this.position.levelX.left) + "px";
                    }
                    break;
                case "arrow":
    ...
    this.hide = function(id) {
        ...
        if (el.level > 1 && this.arrow2) {
            if(XulMenu_arrowSwap) document.getElementById(id + "-arrow").src = this.arrow1;
        }
    ...
    this.show = function(id) {
        ...
        if (el.level > 1 && this.arrow2) {
            if(XulMenu_arrowSwap) document.getElementById(id + "-arrow").src = this.arrow2;
        }
